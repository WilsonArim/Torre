...
function addTorreModels() {
  try {
    ...
    if (modelSelector) {
      ...
      console.log(
        "🏰 Seletor de modelos não encontrado, tentando método alternativo...",
      );
      ...
      allSelects.forEach((select) => {
        if (
          ...
          console.log(
            "🏰 Seletor de modelos encontrado (método alternativo):",
            select,
          );
    ...
    if (window.showInformationMessage) {
      ...
      console.log(
        "🏰 Modelos da Torre adicionados! Agora podes selecioná-los.",
      );
    }
  } catch (error) {
